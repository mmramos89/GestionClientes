...
public class MenuClientes extends Clientes {
    ...
    private void menu() {
        ...
        while (!salir) {
            ...
            try {
                String menuOpcion = JOptionPane.showInputDialog("Inrese opción: \n"
                        + "* 1 Agregar cliente\n"
                        + "* 2 Editar cliente\n"
                        + " * 3 Eliminar cliente\n"
                        + "* 4 Agregar productos\n"
                ...
                switch (opcion) {
                    case 1:
                        ...
                        String telefono = JOptionPane.showInputDialog("Telefono cliente");
                        String direccion = JOptionPane.showInputDialog("Direccion  cliente");
                        ...
                        break;
                    case 2:
                        String nombreBusqueda = JOptionPane.showInputDialog("ingrese nombre a buscar");
